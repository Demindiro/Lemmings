...
sys!(42 connect(fd: i32, addr: *const (), addrlen: u32) -> i32);
sys!(43 accept(fd: i32, addr: *mut (), addrlen: *mut u32) -> i32);
sys!(49 bind(fd: i32, addr: *const (), addrlen: u32) -> i32);
sys!(50 listen(fd: i32, backlog: u32) -> i32);
